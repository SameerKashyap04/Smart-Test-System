...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_profile') {
    ...
    $sql = "UPDATE users SET college = ?, branch = ?, roll_no = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "sssi", $college, $branch, $roll_no, $_SESSION['user_id']);
...
$stmt = mysqli_prepare($conn, 'SELECT username, email, college, branch, roll_no, profile_image, id_document_path, email_verified FROM users WHERE id = ?');
mysqli_stmt_bind_param($stmt, 'i', $_SESSION['user_id']);
mysqli_stmt_execute($stmt);
            ...
            <div class="dashboard-padding">
                ...
                <div class="row g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="list-group list-group-flush text-start rounded">
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <span><i class="fas fa-id-badge me-2 text-primary"></i>Roll No</span>
                                        <span class="fw-bold"><?php echo htmlspecialchars($info['roll_no'] ?: 'Not Set'); ?></span>
                                    </div>
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-8">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="roll_no" class="form-control" value="<?php echo htmlspecialchars($info['roll_no']); ?>" required>
                                        </div>
                                    </div>
                        ...
                        <!-- ID Card Section -->
                        <div class="card mb-4 border-0 shadow-sm">
                            <div class="card-header bg-white py-3 border-bottom"><h5 class="mb-0 fw-bold"><i class="fas fa-id-card me-2 text-primary"></i> College ID Card</h5></div>
                            <div class="card-body p-4">
