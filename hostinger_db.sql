-- Smart Test System - Hostinger Database Setup
-- Import this file in your Hostinger phpMyAdmin

-- Create database (Commented out because Hostinger usually creates the DB for you)
